...
export function MixedNoiseBackground({
  ...
  const getNoiseGenerator = useCallback((type: NoiseType, seed: number) => {
  ...
  const getNoiseValue = useCallback(
    (layer: NoiseLayer, x: number, y: number): number => {
  ...
  const getMixedNoiseValue = useCallback(
  ...
  }, [getMixedNoiseValue, resolution, colors, opacity]);
